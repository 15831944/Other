...
//	int ShowHBDataStr(char* Capt, void* Data, int DataType, int isBtn = TRUE);
	...
	int ShowHBDataStr(char* Capt, void* DataW, void* DataS, int DataType, int ShowType /* = BousHandlEdt*/,
		BtnFunct* ClickFnW = NULL, BtnFunct* ClickFnS = NULL, CADORecord* ptrCurrentRecordset = NULL);
	int ShowDataStr(char* Capt, void* Data, int DataType, int IsReadOnly = 0);
	int ShowDataStr(char* Capt, void* Data, int DataType, CADORecord* ptrCurrentRecordset);
