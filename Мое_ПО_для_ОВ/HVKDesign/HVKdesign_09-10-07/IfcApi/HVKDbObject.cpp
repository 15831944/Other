...
//---------------------------------------------------------------------------
void CHVKDbObject::SaveCurADORecord()
{
	m_ADOlist.push_back(CHVKDbObject::m_ptrAdoRc);
}
//---------------------------------------------------------------------------
void CHVKDbObject::RestorePrevADORecord()
{
	CHVKDbObject::m_ptrAdoRc = (CADORecord*)(*(--(m_ADOlist.end())));
	m_ADOlist.pop_back();
}
//---------------------------------------------------------------------------
