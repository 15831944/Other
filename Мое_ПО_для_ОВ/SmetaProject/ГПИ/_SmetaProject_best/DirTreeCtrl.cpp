...
void CDirTreeCtrl::Initialize(bool clear)
{
	...
	m_drives_root=AddItem_Core("Диски", TVI_ROOT, true, mycomputerIcon, mycomputerIcon);
...
//если в откпываемой папке нет подпапок
//	if (!bOne) InsertItem("",9999,9999,parent);
}
